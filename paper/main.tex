...
% E4 ablation modes
\providecommand{\rotstePsnr}{??}
\providecommand{\rotsteSsim}{??}
\providecommand{\rotsteUsage}{??}
\providecommand{\rotstePerplexity}{??}
\providecommand{\rotnorotPsnr}{??}
\providecommand{\rotnorotSsim}{??}
\providecommand{\rotnorotUsage}{??}
\providecommand{\rotnorotPerplexity}{??}
\providecommand{\rotnorescPsnr}{??}
\providecommand{\rotnorescSsim}{??}
\providecommand{\rotnorescUsage}{??}
\providecommand{\rotnorescPerplexity}{??}
\providecommand{\rotfullPsnr}{??}
\providecommand{\rotfullSsim}{??}
\providecommand{\rotfullUsage}{??}
\providecommand{\rotfullPerplexity}{??}
% Entropy-regularised RotationVQ (full lambda sweep + 12k run)
\providecommand{\rotlamAPsnr}{??}
\providecommand{\rotlamASsim}{??}
\providecommand{\rotlamAUsage}{??}
\providecommand{\rotlamAPerplexity}{??}
\providecommand{\rotlamBPsnr}{??}
\providecommand{\rotlamBSsim}{??}
\providecommand{\rotlamBUsage}{??}
\providecommand{\rotlamBPerplexity}{??}
\providecommand{\rotlamCPsnr}{??}
\providecommand{\rotlamCSsim}{??}
\providecommand{\rotlamCUsage}{??}
\providecommand{\rotlamCPerplexity}{??}
\providecommand{\rotentPsnr}{??}
\providecommand{\rotentSsim}{??}
\providecommand{\rotentUsage}{??}
\providecommand{\rotentPerplexity}{??}
\providecommand{\rotentSamplespersec}{??}
